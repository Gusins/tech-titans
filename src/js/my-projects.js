...
const projects = [
	{
		img: {
			src: 'src/img/my-projects/wallet.jpg',
			srcset: 'src/img/my-projects/wallet.jpg 1x, src/img/my-projects/wallet-2x.jpg 2x',
	...
	{
		img: {
			src: 'src/img/my-projects/green.jpg',
			srcset: 'src/img/my-projects/green.jpg 1x, src/img/my-projects/green-2x.jpg 2x',
	...
	{
		img: {
			src: 'src/img/my-projects/english.jpg',
			srcset: 'src/img/my-projects/english.jpg 1x, src/img/my-projects/english-2x.jpg 2x',
	...
	{
		img: {
			src: 'src/img/my-projects/power.jpg',
			srcset: 'src/img/my-projects/power.jpg 1x, src/img/my-projects/power-2x.jpg 2x',
	...
	{
		img: {
			src: 'src/img/my-projects/mimino.jpg',
			srcset: 'src/img/my-projects/mimino.jpg 1x, src/img/my-projects/mimino-2x.jpg 2x',
			alt: 'mimino website'
		},
		stack: 'React, JavaScript, Node JS, Git',
	...
	{
		img: {
			src: 'src/img/my-projects/vyshyvanka.jpg',
			srcset: 'src/img/my-projects/vyshyvanka.jpg 1x, src/img/my-projects/vyshyvanka-2x.jpg 2x',
	...
	{
		img: {
			src: 'src/img/my-projects/chego.jpg',
			srcset: 'src/img/my-projects/chego.jpg 1x, src/img/my-projects/chego-2x.jpg 2x',
	...
	{
		img: {
			src: 'src/img/my-projects/energy.jpg',
			srcset: 'src/img/my-projects/energy.jpg 1x, src/img/my-projects/energy-2x.jpg 2x',
	...
	{
		img: {
			src: 'src/img/my-projects/fruit.jpg',
			srcset: 'src/img/my-projects/fruit.jpg 1x, src/img/my-projects/fruit-2x.jpg 2x',
	...
	{
		img: {
			src: 'src/img/my-projects/starlight.jpg',
			srcset: 'src/img/my-projects/starlight.jpg 1x, src/img/my-projects/starlight-2x.jpg 2x',
    ...
    <div class="projects-card-container">
      ...
      <a class="projects-card-link" href="${project.link}" target="_blank">
        ...
        <svg class="projects-card-link-svg" width="24" height="24">
          <use href="src/img/svg/spriteForEachOpt.svg#MyProjectVector"></use>
        </svg>
      </a>
    </div>
  </li>`;
